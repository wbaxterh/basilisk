 ...
 * volume/liquidity.
 *
 * Every entry below was verified empirically on 2026-07-11: a request to
 *   GET https://api.dexscreener.com/tokens/v1/cardano/{addr1,addr2,...}
 * returned >= 1 live cardano pair for each address, and each removal was
 * double-checked via GET /token-pairs/v1/cardano/{addr} (0 pairs, any side).
 *
 * HOW TO REGENERATE:
 ...
 *
 * REMOVED 2026-07-11 (zero live DexScreener pairs — pools drained/delisted):
 ...
 *   TCOIN   ec6ec45fc2275a2380b16449c1e34869dc0b6609bdf17a8b7c9f1cb4546f6d61746f436f696e
 *   PAVIA   884892bcdc360bcef87d6b3f806e7f9cd5ac30d999d49970e7a903ae5041564941
 *   NIKEPIG c881c20e49dbaca3ff6cef365969354150983230c39520b917f5cf7c4e696b65
 ...
 *   SKY     60faa64709fede8dffed0dccb69da337a5bf61eda0c773156ea78b4d534b59
 * ADDED 2026-07-11 (search-mined, >= 1 live cardano pair confirmed):
 *   COPI, AGIX, MIN, AGENT, USDC, iSOL
 *
...
export const TOKEN_REGISTRY: RegistryToken[] = [
  ...
  { address: "b6a7467ea1deb012808ef4e87b5ff371e85f7142d7b356a40d9b42a0436f726e75636f70696173205b76696120436861696e506f72742e696f5d", symbol: "COPI", name: "Cornucopias Token" },
  { address: "f43a62fdc3965df486de8a0d32fe800963589c41b38946602a0dc53541474958", symbol: "AGIX", name: "SingularityNet AGIX Token" },
  { address: "29d222ce763455e3d7a09a665ce554f00ac89d2e99a1a83d267170c64d494e", symbol: "MIN", name: "Minswap" },
  { address: "97bbb7db0baef89caefce61b8107ac74c7a7340166b39d906f174bec54616c6f73", symbol: "AGENT", name: "Agent (Talos)" },
  { address: "25c5de5f5b286073c593edfd77b48abc7a48e5a4f3d4cd9d428ff93555534443", symbol: "USDC", name: "USDC" },
  { address: "f66d78b4a3cb3d37afa0ec36461e51ecbde00f26c8f0a68f94b6988069534f4c", symbol: "iSOL", name: "iSOL" },
];
